...
# 类内子项过滤
npx auriga-cli install skills --skill playwright-cli
...
Targeted — single category:
  ...
  npx -y auriga-cli install skills --skill playwright-cli
...
```json
{
  ...
  "workflowSkills": [{ "name": "playwright-cli", "description": "..." }],
...
- [ ] `npx auriga-cli install skills --skill playwright-cli` 只装指定 skill
