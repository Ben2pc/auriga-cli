...
| [`verification-before-completion`](../../../worklog/worklog-2026-07-14-refactor-remove-verification-skill/verification-before-completion/review.md) | `obra/superpowers` | Claude Code / Codex | PR #181 已完成实现并归档子规范；删除并由工作流规则与确定性机制替代；模型评测未执行 |
