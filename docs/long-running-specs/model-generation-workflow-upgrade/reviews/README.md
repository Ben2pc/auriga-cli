...
| [`git-workflow`](../../../worklog/worklog-2026-07-16-refactor-simplify-git-workflow/git-workflow-modernization/review.md) | Auriga 插件 | Claude Code / Codex | 精简已落地 PR #189 并归档子规范与规划记录；删除通用 Git 教学与 Hook 实现细节，保留仓库安全、提交、拉取请求、评审反馈和合并契约；仓库测试、门禁测试、官方校验器、打包安装与三种作用域 Web UI 检查均通过；模型评测未执行 |
