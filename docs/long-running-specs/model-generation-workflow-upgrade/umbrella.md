...
| VAL-MIG-001 | [统一测试驱动开发](../../worklog/worklog-2026-07-14-refactor-simplify-tdd-skill/unified-tdd-skill/validation-contract.md) | VAL-ASSET-001、VAL-FLOW-001..002 | 两个测试入口收敛为一个，移除独立测试代理要求 |
